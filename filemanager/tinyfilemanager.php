...
$CONFIG = '{"lang":"pt","error_reporting":false,"show_hidden":false,"hide_Cols":false,"theme":"dark"}';
...
$root_path = $_SERVER['DOCUMENT_ROOT'] . "/codemaster/sebastiao_alves/uploads";

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url =   "/codemaster/sebastiao_alves/uploads";
